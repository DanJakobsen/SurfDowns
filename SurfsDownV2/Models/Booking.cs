...
using static SurfsDownV2.Models.WetSuit;
...
namespace SurfsDownV2.Models
{
    public class Booking
    {
        ...
        public string RentHours { get; set; } = ""; //lejetiden
        ...
        public Booking(int bookingId, string customerName, string customerEmail, string customerPhone, string selectedSurfboard, DateTime rentPeriod, string rentHours, DateTime rentReturn, string? remarks, int price, int surfboardAmount, DateTime bookingtime, WetSuitGender gender, WetSuitSize size)
        {
            BookingId = bookingId;
