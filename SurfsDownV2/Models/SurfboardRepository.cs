namespace SurfsDownV2.Models
{
    ...
    {
        public static List<Surfboard> Surfboards { get; set; } = new List<Surfboard>();
        ...
        public static List<Surfboard> Get_Surfboards() => Surfboards;
        ...
        /// <returns></returns>
        public static bool Add_Surfboard(Surfboard surfboardToAdd)
        {
            bool wasAdded = false;
        ...
        /// </summary>
        /// <returns></returns>
        public static Surfboard Get_Surfboard_ByBoardName(string boardName)
        {
            if (Surfboards != null)
            {
        ...
        /// <returns></returns>
        public static bool Update_Surfboard_Length(string nameOfSurfboardToUpdate, float newLength)
        {
        ...
        /// <param name="newLength"></param>
        /// <returns></returns>
        public static bool Update_Surfboard_Width(string nameOfSurfboardToUpdate, float newWidth)
        {
            bool updatedSuccesfully = false;
        ...
        /// <param name="newLength"></param>
        /// <returns></returns>
        public static bool Update_Surfboard_Thickness(string nameOfSurfboardToUpdate, float newThickness)
        {
            bool updatedSuccesfully = false;
        ...
        /// <param name="newLength"></param>
        /// <returns></returns>
        public static bool Update_Surfboard_Volume(string nameOfSurfboardToUpdate, float newVolume)
        {
            bool updatedSuccesfully = false;
        ...
        /// <param name="newLength"></param>
        /// <returns></returns>
        public static bool Update_Surfboard_Price(string nameOfSurfboardToUpdate, int newPrice)
        {
            bool updatedSuccesfully = false;
        ...
        /// <param name="newLength"></param>
        /// <returns></returns>
        public static bool Update_Surfboard_Equipment_OnlyAdding(string nameOfSurfboardToUpdate, string equipmentToAdd)
        {
            bool updatedSuccesfully = false;
        ...
        /// <returns></returns>
        public static bool Update_Surfboard_Equipment_ByOverwriting(string nameOfSurfboardToUpdate, string equipmentToOverwriteWith)
        {
            bool updatedSuccesfully = false;
        ...
        /// <returns></returns>
        public static bool Remove_Surfboard(Surfboard surfboardToRemove)
        {
